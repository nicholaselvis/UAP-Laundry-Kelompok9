                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part d-flex align-items-center mb-0"> 
                                <span class="counter text-success">5</span>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">Histori Transakso</h3>
                            </div>
                                ...
                                <table class="table no-wrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="text-success">1 Jam</span></td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            ...
                                            <td><span class="text-info">3 Jam</span></td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            <td class="txt-oflo">Rafaela</td>
                                            <td class="txt-oflo">April 20, 2021</td>
                                            <td><span class="text-info">2 Jam</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
