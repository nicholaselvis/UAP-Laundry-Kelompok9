                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        ...
                        <div class="d-md-flex mb-3">
                            ...
                            <div class="table-responsive">
                                <form action="<?= base_url('/admin/kasirstore')?>" method="POST">
                                    <label for="">Nama : </label>
                                        <input class="form-control" type="text" placeholder="Default input" aria-label="default input example" type="text" name="nama" id="" style="width: 20%" value="<?= old('nama') ?>">
                                        <br>  
                                    
                                    <label for="">Umur : </label>
                                        <input class="form-control" type="text" placeholder="Default input" aria-label="default input example" type="text" name="umur" id="" style="width: 20%" value="<?= old('umur') ?>">
                                        <br>    
                                        
                                        <label for="">Jenis Kelamin : </label>
                                            <select class="custom-select" name="jeniskelamin" id="" style="width: 20%">
