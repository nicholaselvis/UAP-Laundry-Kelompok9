...
class TransaksiModel extends Model
{
    ...
    protected $allowedFields    = ['id_customer', 'nama', 'id_mesin_cuci', 'kapasitas_pesanan', 'total_transaksi','tanggal_booking','waktu'];
    ...
    public function getTransaksiByMesinCuci($id_mesin_cuci)
    {
        return $this->where('id_mesin_cuci', $id_mesin_cuci)->findAll();
    }
